...
namespace PicoContainer.Defaults
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Defaults.PicoInvocationTargetInitializationException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		public PicoInvocationTargetInitializationException()
		{
		}
		...
		public PicoInvocationTargetInitializationException(Exception ex) : base(ex.Message, ex)
		{
		}


		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Defaults.PicoInvocationTargetInitializationException"/> class with a 
		...
		public PicoInvocationTargetInitializationException(string message) : base(message)
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Defaults.PicoInvocationTargetInitializationException"/> class with a specified error message 
		...
		public PicoInvocationTargetInitializationException(string message, Exception ex) : base(message, ex)
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Defaults.PicoInvocationTargetInitializationException"/> class with serialized data.
		/// </summary>
		/// <remarks>
		...
		protected PicoInvocationTargetInitializationException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
