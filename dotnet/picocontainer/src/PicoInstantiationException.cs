...
namespace PicoContainer
{
  ...
  public class PicoInstantiationException : PicoException
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PicoContainer.PicoInstantiationException"/> class.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public PicoInstantiationException() : base("An exception occurred while initiating a component"){ }

    /// <summary>
    /// Initializes a new instance of the <see cref="PicoContainer.PicoInstantiationException"/> class with a specified error message.
    /// </summary>
    /// <remarks>
    ...
    public PicoInstantiationException(Exception ex) : base (ex) {}
    
    /// <summary>
    /// Initializes a new instance of the <see cref="PicoContainer.PicoInstantiationException"/> class with a 
    ...
    public PicoInstantiationException(string message) : base(message) { }
    ...
    public PicoInstantiationException(string message, Exception ex) : base(message,ex) {}

    /// <summary>
    /// Initializes a new instance of the <see cref="PicoContainer.PicoInstantiationException"/> class with serialized data.
    /// </summary>
    /// <remarks>
    ...
    protected PicoInstantiationException(SerializationInfo info, StreamingContext context) : base (info, context) {}
