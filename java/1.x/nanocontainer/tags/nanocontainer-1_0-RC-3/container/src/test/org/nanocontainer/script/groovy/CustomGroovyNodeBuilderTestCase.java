...
public class CustomGroovyNodeBuilderTestCase extends AbstractScriptedContainerBuilderTestCase {
    ...
    public void testValidationTurnedOnThrowsExceptionForUnknownAttributes() {
        ...
        try {
            buildContainer(script, parent, ASSEMBLY_SCOPE);
            fail("CustomGroovyNodeBuilder with validation should have thrown NanoContainerMarkupException");
    ...
    public void testValidationTurnedOffDoesntThrowExceptionForUnknownAttributes() {
        ...
        try {
            ...
            fail("CustomGroovyNodeBuilder with validation turned off should never have thrown NanoContainerMarkupException: " + ex.getMessage());
        }
