...
/**
 * ServletContainerFinder looks up a scoped PicoContainer in a web context. By default, it looks in succession in the
 * request, session and application scopes. This class may be extended the
 * {@link ServletContainerFinder#findContainer(HttpServletRequest)}overridden to provide different lookup criteria or
 * priority.
 * 
...
public class ServletContainerFinder {
	...
	/**
	 * Looks for a PicoContainer in succession in the request, session and application scopes of an HttpServletRequest.
	 * 
