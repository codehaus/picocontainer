...
public class NanoWebServletComponent {
    ...
    public void service(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        if (result instanceof String) {
            ...
            throw new ServletException("Only String return is valid yet.");
        }
    }

    private void setViewContext(Object action, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException {
        BeanInfo beanInfo;
        try {
