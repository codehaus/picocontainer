...
/**
 * Uses Pico to produce Actions and inject dependencies into them. Use this class if you are using the Tiles library. If
 * not, you can use the {@link org.nanocontainer.nanowar.sample.struts.PicoRequestProcessor} instead.
 * 
