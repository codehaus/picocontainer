...
public class TestContainerMockerTestCase extends TestCase implements KeyConstants {
	...
	public void doNot_testThatItMocksProperly() throws Exception {
		...
		assertSame(mocker.getApplicationContainer().getComponentInstance("applicationScopedInstance"), mocker.getRequestContainer()
				.getComponentInstance("applicationScopedInstance"));
