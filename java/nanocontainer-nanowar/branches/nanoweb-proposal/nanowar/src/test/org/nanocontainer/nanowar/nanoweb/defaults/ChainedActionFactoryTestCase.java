...
public class ChainedActionFactoryTestCase extends MockObjectTestCase {
	...
	public void testBasic() throws Exception {
		...
		// nothing from factory 4

		ChainedActionFactory chainedLoader = new ChainedActionFactory(new ActionFactory[] { (ActionFactory) factory1.proxy(),
				(ActionFactory) factory2.proxy(), (ActionFactory) factory3.proxy(), (ActionFactory) factory4.proxy() });
