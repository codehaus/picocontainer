...
/**
 * A MBeanInfoProvider that searches for a MBeanInfo instance in the PicoContainer. Keys of both components follow naming
 * conventions.
...
public class ComponentKeyConventionMBeanInfoProvider extends AbstractNamingConventionMBeanInfoProvider {
    ...
    /**
     * Use the key of the component to search for a MBeanInfo in the PicoContainer. The matching MBeanInfo must be stored in the
     * PicoContainer. The key of the MBeanInfo follows the naming scheme &quot;&lt;ComponentKey&gt;MBeanInfo&quot;. The the
     * component's key is a type, the class name is used as prefix otherwise the string representation of the key. The key part
    ...
    public MBeanInfo provide(final PicoContainer picoContainer, final ComponentAdapter componentAdapter) {
        ...
        return instantiateMBeanInfo(mBeanInfoName, picoContainer, componentAdapter.getComponentImplementation().getClassLoader());
    }
