...
/**
 * A MBeanInfoProvider that searches for a MBeanInfo instance in the PicoContainer. The key of the MBeanInfo is calculated from
 * the component type following naming conventions.
