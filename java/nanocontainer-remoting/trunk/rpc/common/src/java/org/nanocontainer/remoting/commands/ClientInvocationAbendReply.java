...
/**
 * Class ClientInvocationAbendReply - a special case for Callback transports.
 *
 * @author Paul Hammant
 * @version $Revision: 1.2 $
 */
public final class ClientInvocationAbendReply extends Reply {
     ...
     */
    public ClientInvocationAbendReply(IOException replyExcpt) {
