...
public class OldDefaultNanoContainerTestCase extends TestCase {
    ...
    public void testBasic() throws PicoCompositionException, PicoCompositionException {
    ...
    public void testNoGenerationRegistration() throws PicoCompositionException, PicoCompositionException {
        NanoContainer nanoContainer = new DefaultNanoContainer();
        try {
