...
public class AnnotationInjectionComponentAdapterFactory extends MonitoringComponentAdapterFactory {
    ...
    public AnnotationInjectionComponentAdapterFactory(LifecycleStrategy lifecycleStrategy) {
...
*                                the number of the setter. @return Returns a new {@link org.picocontainer.adapters.SetterInjectionComponentAdapter}.
     * @throws org.picocontainer.PicoIntrospectionException if dependencies cannot be solved
    ...
    public ComponentAdapter createComponentAdapter(ComponentCharacteristic registerationCharacteristic, Object componentKey, Class componentImplementation, Parameter... parameters)
        ...
        return new AnnotationInjectionComponentAdapter(componentKey, componentImplementation, parameters, currentMonitor(), lifecycleStrategy);
    }
}