...
public class ImplementationHidingComponentAdapterFactoryTestCase extends AbstractComponentAdapterFactoryTestCase {
    ...
    public void testTheThingThatPaulDoesNotLikeAboutTheCurrentHotSwapper() {
        ...
        ImplementationHidingComponentAdapter ca = (ImplementationHidingComponentAdapter) pico.addComponent(List.class, ArrayList.class).lastCA();
    ...
    public void testInterferingSwapMethodsInComponentMasksHotSwappingFunctionality() {
        MutablePicoContainer pico = new DefaultPicoContainer();
        pico.addAdapter(new ImplementationHidingComponentAdapter(new ConstructorInjectionComponentAdapter(
    ...
    public void testShouldBeAbleToHandleMutualDependenciesWithoutInterfaceImplSeparation() {
        MutablePicoContainer pico = new DefaultPicoContainer(new CachingComponentAdapterFactory(
                new ImplementationHidingComponentAdapterFactory(new ConstructorInjectionComponentAdapterFactory())));
