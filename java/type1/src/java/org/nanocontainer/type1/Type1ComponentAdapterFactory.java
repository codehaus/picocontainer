...
/**
 * An {@link ComponentAdapterFactory} which creates {@link Type1ComponentAdapter}s.
 * 
 * @author <a href="lsimons at jicarilla dot org">Leo Simons</a>
 * @version $Revision$
 */
public class Type1ComponentAdapterFactory implements ComponentAdapterFactory {
    /**
     * {@inheritDoc}
     * 
    ...
    public ComponentAdapter createComponentAdapter(final Object componentKey, final Class componentImplementation, final Parameter[] parameters) throws PicoIntrospectionException, AssignabilityRegistrationException, NotConcreteRegistrationException {
        return new Type1ComponentAdapter(componentKey, componentImplementation);
    }
}
