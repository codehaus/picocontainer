...
import org.nanocontainer.type1.NullArgumentException;
import org.nanocontainer.type1.PicoContainerBasedServiceManager;
...
public class PicoContainerBasedServiceManagerTestCase extends TestCase {
    ...
    public void testLookup() throws ServiceException {
        ...
        mock.getComponentInstance("blah");
        mockControl.setReturnValue(this);

        mock.getComponentInstance(null);
        mockControl.setReturnValue(null);
        
        mock.getComponentInstance("org.apache.avalon.framework.service.ServiceManager");
        mockControl.setReturnValue(null);
        mock.getComponentInstance(ServiceManager.class);
        ...
        mock.getComponentInstance("test");
        mockControl.setThrowable(problem);

        mock.getComponentInstance("org.apache.avalon.framework.service.NoSuchServiceManager");
        mockControl.setReturnValue(null);
