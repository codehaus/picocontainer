	...
	public class TypeLoaderTestCase
	{
		...
		public void FullType()
		{
			Stream strm = Assembly.GetExecutingAssembly()
				.GetManifestResourceStream(@"NanoContainer.Tests.TestScripts.test.cs");
		...
		{
			TypeLoader.GetType("aaa,aaa,aaa,aaa,aaa");
		}
		...
		{
			Stream strm = Assembly.GetExecutingAssembly().GetManifestResourceStream(@"NanoContainer.Tests.TestScripts.test.cs");
