...
namespace NanoContainer.IntegrationKit {
  /// <summary>
  /// Summary description for LifeCycleContainerBuilder.
  /// </summary>
  public abstract class LifeCycleContainerBuilder : ContainerBuilder {
    public void BuildContainer(IObjectReference containerRef, IObjectReference parentContainerRef, Object assemblyScope) {
