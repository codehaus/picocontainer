...
namespace PicoContainer.Core
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Core.PicoIntrospectionException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Core.PicoIntrospectionException"/> class with a specified error message.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Core.PicoIntrospectionException"/> class with a 
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.Core.PicoIntrospectionException"/> class with serialized data.
		/// </summary>
		/// <remarks>
