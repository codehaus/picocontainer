...
namespace PicoContainer
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.PicoInitializationException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.PicoInitializationException"/> class with a 
		...
		public PicoInitializationException(Exception ex) : base(ex.Message, ex)
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.PicoInitializationException"/> class with a specified error message.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PicoContainer.PicoInitializationException"/> class with a specified error message and a 
		/// reference to the inner exception that is the cause of this exception.
		/// </summary>
		/// <remarks>
		...
		public PicoInitializationException(string message, Exception ex) : base(message, ex)
		{
		}
		...
		protected PicoInitializationException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}