...
/**
 * Mock class for a PortableRemoteObjectDelegate. This class substitutes the
 * implementation of the JDK narrowing an EJB home interface. The class is
 * registered in a file orb.properties located in the user.home directory. For
 * unit tests just set user.home to the proper directory.
...
public class PortableRemoteObjectDelegateMock
    ...
    /**
     * Set the narrow {@link Map}. The key is the looked-up element, the value
     * the constructor of the home interface.
    ...
    /**
     * @see javax.rmi.CORBA.PortableRemoteObjectDelegate#connect(java.rmi.Remote,
     *      java.rmi.Remote)
     */
    ...
    /**
     * @see javax.rmi.CORBA.PortableRemoteObjectDelegate#narrow(java.lang.Object,
     *      java.lang.Class)
     */
    public Object narrow(Object narrowFrom, Class narrowTo) throws ClassCastException {
        ...
        if (ctor != null) {
            final ClassCastException cce = new ClassCastException(ctor.getDeclaringClass()
                    .getName());
            try {
