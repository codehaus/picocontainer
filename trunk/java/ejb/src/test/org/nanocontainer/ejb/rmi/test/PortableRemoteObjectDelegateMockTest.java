...
public class PortableRemoteObjectDelegateMockTest
    ...
    public static interface Hello extends EJBObject {
    ...
    public static interface HelloHome extends EJBHome {
    ...
    public static class HelloImpl extends EJBObjectMock implements Hello {
    ...
    public static class HelloHomeImpl extends EJBHomeMock implements HelloHome {
    ...
    public static interface FooHome extends EJBHome {
