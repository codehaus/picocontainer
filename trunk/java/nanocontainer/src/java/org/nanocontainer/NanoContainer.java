 ...
 * @author Paul Hammant
 * @version $Revision$
 * @deprecated All required functionality is in the Main class. It delegates to other classes
 * that are all in PicoExtras.
 */
...
//    }
//
//    protected abstract PicoContainer createPicoContainer() throws PicoAssemblyException;
//
//    protected void init() throws PicoAssemblyException {
