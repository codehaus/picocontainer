...
class ContainerTest < Test::Unit::TestCase
  ...
  def test_registering_component_with_missing_dependencies_raises_error
    ...
    assert_raises NonexistentComponentError do
       rico.register_component :object, Object, [ :nonexistent_key ]
    end
  end
  ...
  def test_gets_component_with_multiple_levels_of_dependencies
    rico = build_rico_with_dependent_components
    rico.register_component :has_nested_dependents, HasNestedDependents, [ :has_dependents ]
    
    # check top level has dependent
    component = rico.component(:has_nested_dependents)
